      ...
      <aside className="hidden md:flex w-72 flex-col p-4">
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-slate-200/70 bg-white/80 shadow-sm backdrop-blur dark:border-slate-800/70 dark:bg-slate-900/60">
          ...
          <Link
            ...
            className="group relative flex items-center gap-2 w-full px-4 py-1.5 rounded-xl mb-7 font-semibold text-slate-500 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md bg-white hover:text-slate-900 hover:bg-slate-100 dark:text-slate-500 dark:bg-slate-900 dark:hover:bg-slate-800 dark:hover:text-white"
          >
            ...
            {filteredNavItems.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`group flex items-center gap-2 px-3 py-1 rounded-xl transition-all font-semibold ${isActive
                ...
                >
                  <span className={`grid h-7 w-5 place-items-center rounded-xl border transition-colors ${isActive
          ...
          <div className="p-4 border-t border-slate-200/70 dark:border-slate-800/70">
            ...
            <button
              ...
              className="flex items-center gap-3 w-full px-3 py-1.5 text-slate-700 dark:text-slate-500 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400 rounded-xl transition-colors font-semibold text-left"
            >
