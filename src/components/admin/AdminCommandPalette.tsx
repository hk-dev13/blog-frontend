  ...
  const navItems: PaletteItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        id: 'nav-users',
        title: 'Users',
        description: 'Recover author accounts',
        href: '/admin/users',
        icon: Users,
        keywords: ['accounts', 'authors', 'email', 'password reset'],
        adminOnly: true,
      },
      {
        kind: 'nav',
        id: 'nav-settings',
        title: 'Settings',
        description: 'Manage login email and password',
        href: '/admin/settings',
        icon: Settings,
        keywords: ['account', 'security', 'email', 'password'],
      },
    ],
    [],
  );
